...
@property (readonly) id<BridgeClientScheduleConfig> _Nullable scheduleConfig __attribute__((swift_name("scheduleConfig")));
...
__attribute__((swift_name("ScheduleConfig")))
@protocol BridgeClientScheduleConfig
@required
- (NSArray<NSString *> * _Nullable)randomizedAssessmentsRefGuid:(NSString *)refGuid __attribute__((swift_name("randomizedAssessments(refGuid:)")));
- (BridgeClientSessionScheduleType *)sessionScheduleTypeRefGuid:(NSString *)refGuid __attribute__((swift_name("sessionScheduleType(refGuid:)")));
@property (readonly) BOOL alwaysRandomizedAssessments __attribute__((swift_name("alwaysRandomizedAssessments")));
@property (readonly) BridgeClientUserAvailabilityConfig * _Nullable availabilityConfig __attribute__((swift_name("availabilityConfig")));
@property (readonly) BridgeClientUserAvailabilityWindow * _Nullable defaultAvailabilityWindow __attribute__((swift_name("defaultAvailabilityWindow")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AppScheduleConfig")))
@interface BridgeClientAppScheduleConfig : BridgeClientBase <BridgeClientScheduleConfig>
- (instancetype)initWithAvailabilityConfig:(BridgeClientUserAvailabilityConfig * _Nullable)availabilityConfig alwaysRandomizedAssessments:(BOOL)alwaysRandomizedAssessments defaultAvailabilityWindow:(BridgeClientUserAvailabilityWindow * _Nullable)defaultAvailabilityWindow randomizedAssessmentsList:(NSArray<NSString *> * _Nullable)randomizedAssessmentsList scheduleType:(BridgeClientSessionScheduleType *)scheduleType __attribute__((swift_name("init(availabilityConfig:alwaysRandomizedAssessments:defaultAvailabilityWindow:randomizedAssessmentsList:scheduleType:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) BridgeClientAppScheduleConfigCompanion *companion __attribute__((swift_name("companion")));
- (BridgeClientAppScheduleConfig *)doCopyAvailabilityConfig:(BridgeClientUserAvailabilityConfig * _Nullable)availabilityConfig alwaysRandomizedAssessments:(BOOL)alwaysRandomizedAssessments defaultAvailabilityWindow:(BridgeClientUserAvailabilityWindow * _Nullable)defaultAvailabilityWindow randomizedAssessmentsList:(NSArray<NSString *> * _Nullable)randomizedAssessmentsList scheduleType:(BridgeClientSessionScheduleType *)scheduleType __attribute__((swift_name("doCopy(availabilityConfig:alwaysRandomizedAssessments:defaultAvailabilityWindow:randomizedAssessmentsList:scheduleType:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSArray<NSString *> * _Nullable)randomizedAssessmentsRefGuid:(NSString *)refGuid __attribute__((swift_name("randomizedAssessments(refGuid:)")));
- (BridgeClientSessionScheduleType *)sessionScheduleTypeRefGuid:(NSString *)refGuid __attribute__((swift_name("sessionScheduleType(refGuid:)")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="randomizedAssessments")
*/
@property (readonly) NSArray<NSString *> * _Nullable randomizedAssessmentsList __attribute__((swift_name("randomizedAssessmentsList")));
@property (readonly) BridgeClientSessionScheduleType *scheduleType __attribute__((swift_name("scheduleType")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AppScheduleConfig.Companion")))
@interface BridgeClientAppScheduleConfigCompanion : BridgeClientBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) BridgeClientAppScheduleConfigCompanion *shared __attribute__((swift_name("shared")));
- (id<BridgeClientKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@property (class, readonly) BridgeClientNotificationType *beforeBurstStart __attribute__((swift_name("beforeBurstStart")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RepeatTimeWindow")))
@interface BridgeClientRepeatTimeWindow : BridgeClientBase
- (instancetype)initWithAvailabilityWindow:(BridgeClientUserAvailabilityWindow *)availabilityWindow expiration:(BridgeClientKotlinx_datetimeDateTimePeriod *)expiration size:(int32_t)size __attribute__((swift_name("init(availabilityWindow:expiration:size:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) BridgeClientRepeatTimeWindowCompanion *companion __attribute__((swift_name("companion")));
- (BridgeClientRepeatTimeWindow *)doCopyAvailabilityWindow:(BridgeClientUserAvailabilityWindow *)availabilityWindow expiration:(BridgeClientKotlinx_datetimeDateTimePeriod *)expiration size:(int32_t)size __attribute__((swift_name("doCopy(availabilityWindow:expiration:size:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (BridgeClientRepeatTimeWindow * _Nullable)ifValid __attribute__((swift_name("ifValid()")));
- (BOOL)isValid __attribute__((swift_name("isValid()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) BridgeClientUserAvailabilityWindow *availabilityWindow __attribute__((swift_name("availabilityWindow")));
@property (readonly) BridgeClientKotlinx_datetimeDateTimePeriod *expiration __attribute__((swift_name("expiration")));
@property (readonly) int32_t size __attribute__((swift_name("size")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RepeatTimeWindow.Companion")))
@interface BridgeClientRepeatTimeWindowCompanion : BridgeClientBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) BridgeClientRepeatTimeWindowCompanion *shared __attribute__((swift_name("shared")));
- (id<BridgeClientKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ScheduledSessionStart")))
@interface BridgeClientScheduledSessionStart : BridgeClientBase
- (instancetype)initWithGuid:(NSString *)guid start:(BridgeClientKotlinx_datetimeLocalTime *)start __attribute__((swift_name("init(guid:start:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) BridgeClientScheduledSessionStartCompanion *companion __attribute__((swift_name("companion")));
- (BridgeClientScheduledSessionStart *)doCopyGuid:(NSString *)guid start:(BridgeClientKotlinx_datetimeLocalTime *)start __attribute__((swift_name("doCopy(guid:start:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *guid __attribute__((swift_name("guid")));
@property (readonly) BridgeClientKotlinx_datetimeLocalTime *start __attribute__((swift_name("start")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ScheduledSessionStart.Companion")))
@interface BridgeClientScheduledSessionStartCompanion : BridgeClientBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) BridgeClientScheduledSessionStartCompanion *shared __attribute__((swift_name("shared")));
- (id<BridgeClientKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="repeatTimeWindow")
*/
@property BridgeClientRepeatTimeWindow * _Nullable repeatTimeWindow __attribute__((swift_name("repeatTimeWindow")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SessionScheduleType")))
@interface BridgeClientSessionScheduleType : BridgeClientKotlinEnum<BridgeClientSessionScheduleType *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) BridgeClientSessionScheduleTypeCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) BridgeClientSessionScheduleType *fixed __attribute__((swift_name("fixed")));
@property (class, readonly) BridgeClientSessionScheduleType *random __attribute__((swift_name("random")));
+ (BridgeClientKotlinArray<BridgeClientSessionScheduleType *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<BridgeClientSessionScheduleType *> *entries __attribute__((swift_name("entries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SessionScheduleType.Companion")))
@interface BridgeClientSessionScheduleTypeCompanion : BridgeClientBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) BridgeClientSessionScheduleTypeCompanion *shared __attribute__((swift_name("shared")));
- (id<BridgeClientKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
- (id<BridgeClientKotlinx_serialization_coreKSerializer>)serializerTypeParamsSerializers:(BridgeClientKotlinArray<id<BridgeClientKotlinx_serialization_coreKSerializer>> *)typeParamsSerializers __attribute__((swift_name("serializer(typeParamsSerializers:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("StudyScheduleConfig")))
@interface BridgeClientStudyScheduleConfig : BridgeClientBase <BridgeClientScheduleConfig>
- (instancetype)initWithAvailabilityConfig:(BridgeClientUserAvailabilityConfig * _Nullable)availabilityConfig defaultAvailabilityWindow:(BridgeClientUserAvailabilityWindow * _Nullable)defaultAvailabilityWindow scheduleTypeMap:(NSDictionary<NSString *, BridgeClientSessionScheduleType *> * _Nullable)scheduleTypeMap randomizedAssessmentsMap:(NSDictionary<NSString *, NSArray<NSString *> *> * _Nullable)randomizedAssessmentsMap __attribute__((swift_name("init(availabilityConfig:defaultAvailabilityWindow:scheduleTypeMap:randomizedAssessmentsMap:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) BridgeClientStudyScheduleConfigCompanion *companion __attribute__((swift_name("companion")));
- (BridgeClientStudyScheduleConfig *)doCopyAvailabilityConfig:(BridgeClientUserAvailabilityConfig * _Nullable)availabilityConfig defaultAvailabilityWindow:(BridgeClientUserAvailabilityWindow * _Nullable)defaultAvailabilityWindow scheduleTypeMap:(NSDictionary<NSString *, BridgeClientSessionScheduleType *> * _Nullable)scheduleTypeMap randomizedAssessmentsMap:(NSDictionary<NSString *, NSArray<NSString *> *> * _Nullable)randomizedAssessmentsMap __attribute__((swift_name("doCopy(availabilityConfig:defaultAvailabilityWindow:scheduleTypeMap:randomizedAssessmentsMap:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSArray<NSString *> * _Nullable)randomizedAssessmentsRefGuid:(NSString *)refGuid __attribute__((swift_name("randomizedAssessments(refGuid:)")));
- (BridgeClientSessionScheduleType *)sessionScheduleTypeRefGuid:(NSString *)refGuid __attribute__((swift_name("sessionScheduleType(refGuid:)")));
...
@property (readonly) BridgeClientUserAvailabilityConfig * _Nullable availabilityConfig __attribute__((swift_name("availabilityConfig")));
@property (readonly) BridgeClientUserAvailabilityWindow * _Nullable defaultAvailabilityWindow __attribute__((swift_name("defaultAvailabilityWindow")));
@property (readonly) NSDictionary<NSString *, NSArray<NSString *> *> * _Nullable randomizedAssessmentsMap __attribute__((swift_name("randomizedAssessmentsMap")));
@property (readonly) NSDictionary<NSString *, BridgeClientSessionScheduleType *> * _Nullable scheduleTypeMap __attribute__((swift_name("scheduleTypeMap")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("StudyScheduleConfig.Companion")))
@interface BridgeClientStudyScheduleConfigCompanion : BridgeClientBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) BridgeClientStudyScheduleConfigCompanion *shared __attribute__((swift_name("shared")));
- (id<BridgeClientKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserAvailabilityConfig")))
@interface BridgeClientUserAvailabilityConfig : BridgeClientBase
- (instancetype)initWithMinimumDuration:(BridgeClientKotlinx_datetimeDateTimePeriod *)minimumDuration maximumDuration:(BridgeClientKotlinx_datetimeDateTimePeriod *)maximumDuration __attribute__((swift_name("init(minimumDuration:maximumDuration:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) BridgeClientUserAvailabilityConfigCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) BridgeClientKotlinx_datetimeDateTimePeriod *maximumDuration __attribute__((swift_name("maximumDuration")));
@property (readonly) BridgeClientKotlinx_datetimeDateTimePeriod *minimumDuration __attribute__((swift_name("minimumDuration")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserAvailabilityConfig.Companion")))
@interface BridgeClientUserAvailabilityConfigCompanion : BridgeClientBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) BridgeClientUserAvailabilityConfigCompanion *shared __attribute__((swift_name("shared")));
- (id<BridgeClientKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserAvailabilityWindow")))
@interface BridgeClientUserAvailabilityWindow : BridgeClientBase
- (instancetype)initWithWakeTime:(BridgeClientKotlinx_datetimeLocalTime *)wakeTime bedTime:(BridgeClientKotlinx_datetimeLocalTime *)bedTime __attribute__((swift_name("init(wakeTime:bedTime:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) BridgeClientUserAvailabilityWindowCompanion *companion __attribute__((swift_name("companion")));
- (int32_t)availabilityInMinutes __attribute__((swift_name("availabilityInMinutes()")));
- (BridgeClientUserAvailabilityWindow *)doCopyWakeTime:(BridgeClientKotlinx_datetimeLocalTime *)wakeTime bedTime:(BridgeClientKotlinx_datetimeLocalTime *)bedTime __attribute__((swift_name("doCopy(wakeTime:bedTime:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (BOOL)isEmpty __attribute__((swift_name("isEmpty()")));
- (NSArray<BridgeClientKotlinx_datetimeLocalTime *> * _Nullable)randomSessionTimesSessionsPerDay:(int32_t)sessionsPerDay windowDuration:(BridgeClientKotlinx_datetimeDateTimePeriod *)windowDuration __attribute__((swift_name("randomSessionTimes(sessionsPerDay:windowDuration:)")));
- (NSString *)description __attribute__((swift_name("description()")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="bed")
*/
@property BridgeClientKotlinx_datetimeLocalTime *bedTime __attribute__((swift_name("bedTime")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="wake")
*/
@property BridgeClientKotlinx_datetimeLocalTime *wakeTime __attribute__((swift_name("wakeTime")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserAvailabilityWindow.Companion")))
@interface BridgeClientUserAvailabilityWindowCompanion : BridgeClientBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) BridgeClientUserAvailabilityWindowCompanion *shared __attribute__((swift_name("shared")));
- (BOOL)canRepeatDailySessionsPerDay:(int32_t)sessionsPerDay windowDuration:(BridgeClientKotlinx_datetimeDateTimePeriod *)windowDuration __attribute__((swift_name("canRepeatDaily(sessionsPerDay:windowDuration:)")));
- (id<BridgeClientKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NativeUserAvailabilityWindow")))
@interface BridgeClientNativeUserAvailabilityWindow : BridgeClientBase
- (instancetype)initWithWakeTime:(NSDateComponents *)wakeTime bedTime:(NSDateComponents *)bedTime __attribute__((swift_name("init(wakeTime:bedTime:)"))) __attribute__((objc_designated_initializer));
- (BridgeClientNativeUserAvailabilityWindow *)doCopyWakeTime:(NSDateComponents *)wakeTime bedTime:(NSDateComponents *)bedTime __attribute__((swift_name("doCopy(wakeTime:bedTime:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (BridgeClientUserAvailabilityWindow *)toKotlin __attribute__((swift_name("toKotlin()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSDateComponents *bedTime __attribute__((swift_name("bedTime")));
@property (readonly) NSDateComponents *wakeTime __attribute__((swift_name("wakeTime")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getScheduleConfigWithCompletionHandler:(void (^)(id<BridgeClientScheduleConfig> _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("getScheduleConfig(completionHandler:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ClientDataHelper")))
@interface BridgeClientClientDataHelper : BridgeClientBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)clientDataHelper __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) BridgeClientClientDataHelper *shared __attribute__((swift_name("shared")));
@property (readonly) BridgeClientKotlinx_serialization_jsonJson *jsonCoder __attribute__((swift_name("jsonCoder")));
@end
...
- (BridgeClientParticipantRepoUpdateParticipantRecord *)doCopyId:(NSString *)id firstName:(NSString * _Nullable)firstName lastName:(NSString * _Nullable)lastName sharingScope:(BridgeClientSharingScope * _Nullable)sharingScope dataGroups:(NSMutableArray<NSString *> * _Nullable)dataGroups email:(NSString * _Nullable)email phone:(BridgeClientPhone * _Nullable)phone userScheduleData:(id _Nullable)userScheduleData appClientData:(BridgeClientKotlinx_serialization_jsonJsonElement * _Nullable)appClientData __attribute__((swift_name("doCopy(id:firstName:lastName:sharingScope:dataGroups:email:phone:userScheduleData:appClientData:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property BridgeClientUserAvailabilityWindow * _Nullable availability __attribute__((swift_name("availability")));
@property BridgeClientKotlinx_serialization_jsonJsonElement * _Nullable clientData __attribute__((swift_name("clientData"))) __attribute__((deprecated("This is included for reverse-compatibility to older apps that use the schedule mutator.")));
...
- (NSData * _Nullable)clientDataJson __attribute__((swift_name("clientDataJson()")));
@property (readonly) BridgeClientUserAvailabilityWindow * _Nullable availability __attribute__((swift_name("availability")));
@end
...
@interface BridgeClientKotlinx_datetimeLocalTimeCompanion (Extensions)
@property (readonly) BridgeClientKotlinx_datetimeLocalTime *MIDNIGHT __attribute__((swift_name("MIDNIGHT")));
@end
...
@interface BridgeClientKotlinx_datetimeLocalTime (Extensions)
- (NSDateComponents *)toNSDateComponents __attribute__((swift_name("toNSDateComponents()")));
@end

@interface BridgeClientUserAvailabilityWindow (Extensions)
- (BridgeClientNativeUserAvailabilityWindow *)toNative __attribute__((swift_name("toNative()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NativeTimelineManagerKt")))
@interface BridgeClientNativeTimelineManagerKt : BridgeClientBase
+ (BridgeClientKotlinx_datetimeLocalTime *)toLocalTime:(NSDateComponents *)receiver __attribute__((swift_name("toLocalTime(_:)")));
@end
...
@protocol BridgeClientKotlinx_serialization_coreSerialFormat
@required
...
@protocol BridgeClientKotlinx_serialization_coreStringFormat <BridgeClientKotlinx_serialization_coreSerialFormat>
@required
- (id _Nullable)decodeFromStringDeserializer:(id<BridgeClientKotlinx_serialization_coreDeserializationStrategy>)deserializer string:(NSString *)string __attribute__((swift_name("decodeFromString(deserializer:string:)")));
- (NSString *)encodeToStringSerializer:(id<BridgeClientKotlinx_serialization_coreSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeToString(serializer:value:)")));
@end

__attribute__((swift_name("Kotlinx_serialization_jsonJson")))
@interface BridgeClientKotlinx_serialization_jsonJson : BridgeClientBase <BridgeClientKotlinx_serialization_coreStringFormat>
@property (class, readonly, getter=companion) BridgeClientKotlinx_serialization_jsonJsonDefault *companion __attribute__((swift_name("companion")));
- (id _Nullable)decodeFromJsonElementDeserializer:(id<BridgeClientKotlinx_serialization_coreDeserializationStrategy>)deserializer element:(BridgeClientKotlinx_serialization_jsonJsonElement *)element __attribute__((swift_name("decodeFromJsonElement(deserializer:element:)")));
- (id _Nullable)decodeFromStringString:(NSString *)string __attribute__((swift_name("decodeFromString(string:)")));
- (id _Nullable)decodeFromStringDeserializer:(id<BridgeClientKotlinx_serialization_coreDeserializationStrategy>)deserializer string:(NSString *)string __attribute__((swift_name("decodeFromString(deserializer:string:)")));
- (BridgeClientKotlinx_serialization_jsonJsonElement *)encodeToJsonElementSerializer:(id<BridgeClientKotlinx_serialization_coreSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeToJsonElement(serializer:value:)")));
- (NSString *)encodeToStringSerializer:(id<BridgeClientKotlinx_serialization_coreSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeToString(serializer:value:)")));
- (BridgeClientKotlinx_serialization_jsonJsonElement *)parseToJsonElementString:(NSString *)string __attribute__((swift_name("parseToJsonElement(string:)")));
@property (readonly) BridgeClientKotlinx_serialization_jsonJsonConfiguration *configuration __attribute__((swift_name("configuration")));
@property (readonly) BridgeClientKotlinx_serialization_coreSerializersModule *serializersModule __attribute__((swift_name("serializersModule")));
@end
...
@interface BridgeClientKotlinx_serialization_jsonJsonDefault : BridgeClientKotlinx_serialization_jsonJson
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)default_ __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) BridgeClientKotlinx_serialization_jsonJsonDefault *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Kotlinx_serialization_jsonJsonConfiguration")))
@interface BridgeClientKotlinx_serialization_jsonJsonConfiguration : BridgeClientBase
- (NSString *)description __attribute__((swift_name("description()")));
 ...
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
@property (readonly) id<BridgeClientKotlinx_serialization_jsonJsonNamingStrategy> _Nullable namingStrategy __attribute__((swift_name("namingStrategy")));
...
@protocol BridgeClientKotlinx_serialization_jsonJsonNamingStrategy
@required
- (NSString *)serialNameForJsonDescriptor:(id<BridgeClientKotlinx_serialization_coreSerialDescriptor>)descriptor elementIndex:(int32_t)elementIndex serialName:(NSString *)serialName __attribute__((swift_name("serialNameForJson(descriptor:elementIndex:serialName:)")));
@end
